...
/*
  Implement functionalities according to this, unmodifiable main.cpp file.
  Pay attention to proper memory management and necessary preprocessor directives.
  Valgrind should not detect any memory leaks nor return any error.
*/
